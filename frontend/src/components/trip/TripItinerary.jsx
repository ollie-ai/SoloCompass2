...
export default function TripItinerary({ trip, onEditActivity, onDeleteActivity, onAddActivity, loading, generating, onGenerate }) {
  return (
      ...
      {loading ? (
                        ...
                        <div className="flex-1 space-y-2">
                          ...
                          <div className="flex flex-wrap items-center gap-4 pt-2">
                            ...
                            {activity.type !== 'Transport' && activity.type !== 'Food & Dining' && (
                              <a 
                                href={`https://www.viator.com/search?q=${encodeURIComponent(activity.name)}&location=${encodeURIComponent(trip.destination)}`}
                                target="_blank"
                                rel="noreferrer"
        ...
        <div className="h-full min-h-[500px] flex flex-col items-center justify-center glass-card rounded-xl p-12 text-center">
          ...
          <button 
            onClick={onGenerate} 
            disabled={generating}
            className="rounded-xl px-12 py-4 font-black bg-brand-vibrant text-white hover:bg-emerald-600 shadow-2xl"
          >
